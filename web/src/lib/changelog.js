...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-03-15',
    items: [
      { icon: 'ToggleRight', textKey: 'changelog.v504autoSkipControls', type: 'improvement' },
    ],
  },
  {
    version: '5.0.3',
    date: '2026-03-15',
    items: [
      { icon: 'Copy', textKey: 'changelog.v503crossSourceDupes', type: 'feature' },
    ],
  },
  {
    version: '5.0.2',
    date: '2026-03-15',
    items: [
      { icon: 'Calendar', textKey: 'changelog.v502receiptDate', type: 'fix' },
    ],
  },
  {
    version: '5.0.1',
  ...
  },
  {
    ...
    date: '2026-03-15',
    items: [
      { icon: 'LayoutGrid', textKey: 'changelog.v500pageTabs', type: 'feature' },
      { icon: 'Sidebar', textKey: 'changelog.v500sidebarCleanup', type: 'improvement' },
      { icon: 'Settings', textKey: 'changelog.v500settingsSupport', type: 'improvement' },
      { icon: 'Zap', textKey: 'changelog.v500dashboardActions', type: 'improvement' },
    ],
  },
  {
    version: '4.9.0',
    date: '2026-03-15',
    items: [
      { icon: 'Shield', textKey: 'changelog.v490raceCondition', type: 'fix' },
      { icon: 'Database', textKey: 'changelog.v490indexes', type: 'improvement' },
      { icon: 'Bug', textKey: 'changelog.v490boolNormalize', type: 'fix' },
      { icon: 'Sparkles', textKey: 'changelog.v490emptyStates', type: 'improvement' },
      { icon: 'RefreshCw', textKey: 'changelog.v490syncNow', type: 'improvement' },
      { icon: 'Zap', textKey: 'changelog.v490errorHandling', type: 'improvement' },
    ],
  },
  {
    version: '4.8.1',
    date: '2026-03-14',
    items: [
      { icon: 'Trash2', textKey: 'changelog.v481cascadeDelete', type: 'fix' },
      { icon: 'Type', textKey: 'changelog.v481unknownMerchant', type: 'fix' },
    ],
  },
  {
    version: '4.8.0',
    date: '2026-03-14',
    items: [
      { icon: 'Layers', textKey: 'changelog.v480clickOutside', type: 'improvement' },
      { icon: 'Globe', textKey: 'changelog.v480i18n', type: 'improvement' },
      { icon: 'Eye', textKey: 'changelog.v480a11y', type: 'improvement' },
      { icon: 'Zap', textKey: 'changelog.v480syncBatch', type: 'improvement' },
      { icon: 'Bug', textKey: 'changelog.v480bugfixes', type: 'fix' },
    ],
  },
  {
    version: '4.7.0',
  ...
  },
  {
    ...
    date: '2026-03-14',
    items: [
      { icon: 'Bug', textKey: 'changelog.v461fixes', type: 'fix' },
    ],
  },
  {
    version: '4.6.0',
    date: '2026-03-14',
    items: [
      { icon: 'Download', textKey: 'changelog.v460installMenu', type: 'feature' },
      { icon: 'Trash2', textKey: 'changelog.v460debtDelete', type: 'feature' },
      { icon: 'Smartphone', textKey: 'changelog.v460keyboardFix', type: 'fix' },
    ],
  },
  {
    version: '4.5.5',
    date: '2026-03-14',
    items: [
      { icon: 'Download', textKey: 'changelog.v455installBtn', type: 'feature' },
    ],
  },
  {
    version: '4.5.4',
    date: '2026-03-14',
    items: [
      { icon: 'Smartphone', textKey: 'changelog.v454pwa', type: 'feature' },
    ],
  },
  {
    version: '4.5.3',
    date: '2026-03-14',
    items: [
      { icon: 'Smartphone', textKey: 'changelog.v453installGuide', type: 'feature' },
    ],
  },
  {
    version: '4.5.2',
    date: '2026-03-14',
    items: [
      { icon: 'Smartphone', textKey: 'changelog.v452pwa', type: 'feature' },
      { icon: 'Globe', textKey: 'changelog.v452universal', type: 'improvement' },
    ],
  },
  {
    version: '4.5.1',
