...
const en = {
  ...
  'dashboard.noSpendDaysStat': 'No-Spend Days',
  'dashboard.days': 'days',
  ...
  'dashboard.healthBudget': 'Budget Adherence',
  'dashboard.healthSavings': 'Savings Rate',
  'dashboard.healthNoSpend': 'No-Spend Days',
  'dashboard.healthFund': 'Emergency Fund',
  'dashboard.healthDebt': 'Debt-to-Income',
  ...
  'dashboard.manualBillsMessage': '{count} bill(s) need confirmation: {names}',
  'dashboard.autoBillsMessage': '{count} auto-debit bill(s): {names}',
  'dashboard.autoCreatedDesc': 'Auto-created from recurring: {name}',
  'dashboard.confirmedPaymentDesc': 'Confirmed payment: {name}',
  ...
  'addTransaction.scanDocument': 'Scan document',
  ...
  'addTransaction.transfersSkipped': 'Skipped',
  'addTransaction.savingProgress': 'Saving {current} of {total}...',
  'addTransaction.batchSaved': 'Batch import saved successfully',
  'addTransaction.batchUndone': '{count} transaction(s) removed',
  'addTransaction.undoBatch': 'Undo import',
  'addTransaction.groupByLabel': 'Group by',
  'addTransaction.groupBy_none': 'None',
  'addTransaction.groupBy_category': 'Category',
  'addTransaction.groupBy_date': 'Date',
  'addTransaction.dismissGroup': 'Dismiss all in group',
  'addTransaction.recurringDetected': '{count} potential recurring payment(s) detected',
  'addTransaction.viewAndAdd': 'View & Add',
  'addTransaction.addToRecurring': 'Add to Recurring',
  'addTransaction.recurringAdded': '"{name}" added to recurring payments',
  'addTransaction.inMonths': 'in {count} months',
  'addTransaction.skip': 'Skip',
  'addTransaction.keep': 'Keep',
  'addTransaction.crossSourceAutoSkipped': '{count} transaction(s) already tracked — auto-skipped',
  'addTransaction.crossSourceSkippedTitle': '{count} auto-skipped (already tracked)',
  'addTransaction.undoAutoSkip': 'Undo',
  'addTransaction.showDetails': 'Details',
  'addTransaction.hideDetails': 'Hide',
  'addTransaction.restore': 'Restore',
  'addTransaction.restoreAll': 'Restore all',
  'addTransaction.unknownMerchant': 'Unknown merchant',
  'addTransaction.duplicateFromSource': 'Already tracked as {source}',
  'addTransaction.crossSourceLabel.recurring': 'recurring payment',
  'addTransaction.crossSourceLabel.receipt': 'receipt scan',
  'addTransaction.crossSourceLabel.manual': 'manual entry',
  'addTransaction.crossSourceLabel.nlp': 'quick add',
  'addTransaction.crossSourceLabel.bank_statement': 'bank statement',
  'addTransaction.crossSourceLabel.document': 'document scan',
  'addTransaction.crossSourceLabel.spreadsheet-import': 'spreadsheet import',
  ...
  'quickAdd.placeholder': 'e.g. "12.50 Uber taxi" or "salary 3000"',
  ...
  'quickAdd.failed': 'Could not parse — try "15 Starbucks coffee"',
  ...
  'quickAdd.inputPlaceholder': "Type an expense... e.g. '12.50 Uber taxi'",
  ...
  // ─── Document Scanner ──────────────────────────────────
  'document.dropOrClick': 'Drop document here or click to upload',
  'document.supportedFormats': 'Images & PDFs supported',
  'document.supportedTypes': 'Invoices, utility bills, contracts, tax forms & more',
  'document.uploadBtn': 'Upload',
  'document.cameraBtn': 'Camera',
  'document.reading': 'Reading document...',
  'document.aiAnalyzing': 'AI analyzing document...',
  'document.preparing': 'Preparing results...',
  'document.done': 'Done!',
  'document.failed': 'Failed to process document',
  'document.offlineWarning': 'Document scanning requires an internet connection.',
  'document.pdfOnly': 'Please upload an image or PDF file',
  'document.fileTooLarge': 'File too large (max 20 MB)',
  'document.emptyFile': 'File appears to be empty',
  'document.readTimeout': 'File read timed out — please try a smaller file',
  'document.noTransactions': 'No transactions found in this document',
  'document.canNavigateAway': 'You can navigate away — processing continues in the background',
  'document.tip1': 'Works with invoices, utility bills, contracts, tax forms, warranty cards, and more.',
  'document.tip2': 'For best results, ensure the document is clear and readable.',
  'document.type.invoice': 'Invoice',
  'document.type.utility_bill': 'Utility bill',
  'document.type.maintenance_bill': 'Maintenance bill',
  'document.type.contract': 'Contract',
  'document.type.tax_form': 'Tax form',
  'document.type.warranty': 'Warranty',
  'document.type.insurance': 'Insurance',
  'document.type.medical': 'Medical',
  'document.type.subscription': 'Subscription',
  'document.type.receipt': 'Receipt',
  'document.type.other': 'Other',
  'document.dueDate': 'Due date',
  'document.docNumber': 'Document #',
  'document.billingPeriod': 'Billing period',
  ...
  'recurring.perDay': '/day',
  'recurring.perMo': '/mo',
  'recurring.per2Mo': '/2mo',
  'recurring.perYr': '/yr',
  'recurring.per2Yr': '/2yr',
  'recurring.perWk': '/wk',
  ...
  'networth.deleteConfirm': 'Are you sure you want to delete this account?',
  ...
  'analytics.dayView': 'Day',
  'analytics.weekView': 'Week',
  'analytics.vsLastMonth': 'Compared to last month',
  'analytics.spendingUp': 'Spending up',
  'analytics.spendingDown': 'Spending down',
  ...
  'people.deletePersonConfirm': 'Delete {name} and all their debt history?',
  'people.debtDeleted': 'Debt deleted',
  'people.deleteDebtConfirm': 'Are you sure you want to delete this debt? This will also remove all associated payments.',
  'people.failedDelete': 'Failed to delete debt',
  ...
  'challenges.statsCompleted': '{count} completed',
  'challenges.statsFailed': '{count} failed',
  'challenges.successRate': '{rate}% success rate',
  'challenges.retry': 'Try again',
  'challenges.reachedPercent': 'You reached {pct}% — try again?',
  ...
  'family.inviteCodeGenerating': 'Generating...',
  ...
  'reports.yearComparison': 'Year Comparison',
  'reports.yearComparisonDesc': 'Compare spending year-over-year',
  'reports.yearComparisonTitle': 'Year-over-Year Spending',
  'reports.yearComparisonSubtitle': 'Comparing {current} vs {previous} expenses by month',
  'reports.noYoYData': 'Not enough data for year comparison yet',
  'reports.csv': 'CSV',
  'reports.print': 'Print',
  'reports.to': 'to',
  ...
  'reports.tag.business': 'Business',
  'reports.tag.medical': 'Medical',
  'reports.tag.charity': 'Charity',
  'reports.tag.education': 'Education',
  'reports.tag.work': 'Work',
  ...
  'settings.guideDesc': 'Learn how to use all features',
  'settings.feedbackDesc': 'Report bugs or suggest improvements',
  ...
  'settings.installAppDesc': 'Install LUMET as an app on your device for the best experience — works offline, launches instantly, and feels like a native app.',
  'settings.installAlreadyInstalled': 'LUMET is already installed as an app on this device!',
  'settings.installIosTitle': 'iPhone & iPad (iOS)',
  'settings.installIosSafariOnly': 'Important: You must use Safari. Chrome, Firefox, and other iOS browsers cannot install web apps.',
  'settings.installIosGuideStep1': 'Open LUMET in Safari',
  'settings.installIosGuideStep1Desc': 'If you\'re using Chrome or another browser, copy the URL and paste it in Safari first.',
  'settings.installIosGuideStep2': 'Tap the Share button',
  'settings.installIosGuideStep2Desc': 'The square icon with an arrow pointing up — at the bottom of the screen (iPhone) or top-right (iPad).',
  'settings.installIosGuideStep3': 'Select "Add to Home Screen"',
  'settings.installIosGuideStep3Desc': 'Scroll down in the Share menu to find this option. If you don\'t see it, make sure you\'re in Safari.',
  'settings.installIosGuideStep4': 'Tap "Add" to confirm',
  'settings.installIosGuideStep4Desc': 'You can rename the app if you want, then tap "Add" in the top-right corner. LUMET will appear on your Home Screen.',
  'settings.installAndroidTitle': 'Android',
  'settings.installAndroidStep1': 'Open LUMET in Chrome or Edge',
  'settings.installAndroidStep2': 'Tap the menu button (⋮) in the top-right corner',
  'settings.installAndroidStep3': 'Tap "Install app" or "Add to Home Screen" and confirm',
  'settings.installDesktopTitle': 'Desktop (Windows / Mac / Linux)',
  'settings.installDesktopStep1': 'Open LUMET in Chrome or Edge',
  'settings.installDesktopStep2': 'Click the install icon (⊕) in the address bar, or go to Menu → "Install LUMET"',
  'settings.installButton': 'Install App',
  'settings.installOneClick': 'One click — the app will be installed on your device instantly',
  'settings.installManualHint': 'Follow the step-by-step guide below to install on your device',
  'settings.installGuideToggle': 'Step-by-step install instructions',
  ...
  'settings.telegramStep7': 'Send a receipt photo or text like "12.50 Uber taxi" to your bot!',
  ...
  'admin.totalErrorsLabel': 'total errors',
  'admin.pwaInstalls': 'PWA Installs',
  'admin.pwaPlatforms': 'Install Platforms',
  'admin.pwaNone': 'No installs tracked yet',
  'admin.systemHealthy': 'All Systems Operational',
  'admin.systemDegraded': 'Performance Degraded',
  'admin.systemUnhealthy': 'System Issues Detected',
  'admin.statusDetail': 'Avg response: {avgMs}ms · Error rate: {errorRate}%',
  'admin.cleanupLogs': 'Cleanup',
  'admin.cleanupDesc': 'Delete old API logs (30d) and activity logs (90d)',
  'admin.cleanupSuccess': 'Cleaned {api} API logs and {activity} activity logs',
  'admin.thisWeekShort': 'this week',
  'admin.exportCsv': 'Export CSV',
  'admin.exportedCsv': 'Exported to CSV',
  'admin.searchUsers': 'Search by name or email...',
  'admin.showingCount': 'Showing {count} of {total}',
  'admin.noUsersMatch': 'No users match your search',
  'admin.searchByUser': 'Search by user name...',
  'admin.groupAuth': 'Auth',
  'admin.groupCrud': 'Data',
  'admin.groupAi': 'AI',
  'admin.groupAdmin': 'Admin',
  'admin.loadMore': 'Load more ({remaining} remaining)',
  'admin.errorSummary': '{total} errors — {client} client (4xx), {server} server (5xx)',
  'admin.fullPath': 'Full path',
  'admin.errorMessage': 'Error',
  'admin.timestamp': 'Timestamp',
  'admin.p95ResponseTime': 'Peak Response',
  'admin.avgRequestsHour': 'Avg Req/Hour',
  'admin.slowEndpoints': 'Slow Endpoints',
  'admin.costPerRequest': 'Cost / Request',
  'admin.avgPerCall': 'avg per AI call',
  ...
  'budgets.nothingToCopy': 'All categories from last month already have budgets',
  'budgets.copiedFromLastMonth': 'Copied {count} budgets from {month}',
  ...
  // v4.0.0
  // v4.1.0
  'changelog.v410adminOverhaul': 'Admin panel overhaul — search, filters, sortable columns, expandable rows, CSV export, SLA cards, system health indicator',
  'changelog.v410healthBreakdown': 'Dashboard health score breakdown — collapsible panel showing 5 scoring factors with color-coded progress bars',
  'changelog.v410analyticsWeekly': 'Analytics weekly view toggle — aggregate daily spending into weekly bars, plus category trend comparison vs last month',
  'changelog.v410budgetsCopy': 'Copy Last Month budgets — one-click to replicate previous month budget categories and amounts',
  ...
  // v4.2.1
  'changelog.v430grouping': 'Group reviewed transactions by category or date with collapsible sections',
  ...
  'changelog.v490raceCondition': 'Fixed race condition when switching families — no more stale data flash',
  'changelog.v490indexes': 'Added 10 compound database indexes for faster queries at scale',
  'changelog.v490boolNormalize': 'Fixed boolean rendering bugs — SQLite integers now properly normalized to true/false',
  ...
  'changelog.v510familyRedesign': 'Family Shared Lens — see your family\'s spending without merging accounts, each person keeps their own transactions',
  'changelog.v510visibilityToggle': 'Per-transaction visibility toggle — choose which transactions your family can see with one tap',
  'changelog.v510privacyRules': 'Category privacy rules — auto-set visibility per category so personal spending stays private by default',
  'changelog.v510emailInvites': 'Email invites + simplified family page — invite members by email, streamlined 4-section layout',
  'changelog.v504autoSkipControls': 'Manual override controls for auto-skip — expandable details, per-item restore, and Settings toggle to disable',
  'changelog.v503crossSourceDupes': 'Smart cross-source duplicate detection — bank imports auto-skip transactions already tracked from recurring, receipts, or manual entries',
  'changelog.v502receiptDate': 'Fixed receipt dates showing as "future" — AI now knows today\'s date and future dates are clamped',
  ...
  'changelog.v500dashboardActions': 'Dashboard quick actions updated — Import & Reports replace redundant links',
  'analytics.emptyTitle': 'No data for this month',
  'analytics.emptyDesc': 'Add some transactions to see spending insights and analytics.',
  'analytics.emptyAction': 'Add Transaction',
  'cashflow.emptyTitle': 'No cash flow data yet',
  'cashflow.emptyDesc': 'Start tracking income and expenses to see your cash flow analysis.',
  'cashflow.emptyAction': 'Add Transaction',
  'review.emptyTitle': 'Nothing to review',
  'review.emptyDesc': 'Add some transactions this month to get your monthly financial review.',
  'review.emptyAction': 'Add Transaction',
  'changelog.v481cascadeDelete': 'People page — can now delete persons with settled debt history (cascade deletes payments and debts)',
  'changelog.v481unknownMerchant': 'Transaction display — "Unknown" merchants now show category/description instead, NLP input text more visible',
  ...
  'changelog.v470ai': 'AI improvements: retry on transient failures, stripped unnecessary data from AI payloads',
  'changelog.v461fixes': 'Bug fixes: password change token, Net Worth multi-currency, CashFlow calculations, Analytics projections, admin user deletion atomicity',
  'changelog.v460installMenu': 'Install App button in sidebar — one-click install directly from the menu',
  'changelog.v460debtDelete': 'Delete debts in People — remove any debt record with associated payments',
  'changelog.v460keyboardFix': 'Fixed mobile keyboard zoom issue — screen no longer stays zoomed after closing keyboard',
  'changelog.v455installBtn': 'Install App button in Settings — one-click install on supported browsers, step-by-step guide as fallback',
  'changelog.v454pwa': 'PWA install tracking — see who installed the app in Admin dashboard',
  'changelog.v453installGuide': 'Step-by-step install guide for iOS (Safari), Android, and Desktop added to Settings',
  ...
  'changelog.v442codeReview': 'Full code review: fixed missing fields, race conditions, period labels, and dead code cleanup',
  'changelog.v442auditFix': 'Subscription audit now correctly excludes cancelled and paused items from cost totals',
  ...
  'changelog.v440variableRecurring': 'Variable-amount subscriptions now detected automatically',
  'changelog.v438robustness': 'Fixed display glitch on recurring items and improved detection robustness for various bank statement formats',
  ...
  'changelog.v420documentTypes': 'Supports 11 document types with intelligent category mapping and Romanian document handling',
  'changelog.v420backgroundPdf': 'PDF documents process in the background — navigate away freely while AI analyzes your document',
